...
git clone https://github.com/Felipe-Perez-Ferraro/vet-clinic.git
...
You can't deploy the project yet.
...
Feel free to check the [issues page](https://github.com/Felipe-Perez-Ferraro/vet-clinic/issues).
